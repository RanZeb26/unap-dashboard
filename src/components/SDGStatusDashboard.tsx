        ...
        <div className="flex items-center gap-2 bg-slate-100 p-1.5 rounded-full border border-slate-200">
          ...
          {["All", "Poverty", "Health", "Climate"].map((filter) => (
            <button
              ...
              className="text-xs px-3.5 py-1.5 rounded-full font-bold transition-all bg-white text-slate-800 hover:bg-[#009EDB] hover:text-white shadow-sm"
            >
              {filter}
            </button>
          ))}
          ...
          return (
            <button
              ...
              className={`p-3 rounded-2xl text-left transition-all duration-200 border flex flex-col justify-between h-24 ${
                isSelected
                  ? "bg-white border-[#009EDB] shadow-lg ring-2 ring-[#009EDB]/20 scale-[1.02]"
